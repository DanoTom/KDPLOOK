...
console.log("\npapeleria comercial fuera de las cifras del nicho");
{
  ...
  truthy("y lo dice en el veredicto cuando son muchos",
    mixed.verdict.reasoning.some((r) => r.includes("no son libros")));
  // Pasado un quinto, la lectura ya no es "hay ruido" sino "quien busca esto
  // no quiere un libro".
  truthy("y a partir de un quinto lo lee como intención de búsqueda",
    mixed.verdict.reasoning.some((r) => r.includes("intención de búsqueda")));
